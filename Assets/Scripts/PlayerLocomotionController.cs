...
public class PlayerLocomotionController : MonoBehaviour
{
    ...
    //Things to look up for future reference:
    //Serialize Field,
    //bennefites of private feilds vs not classified,
    //bennefits of awake vs start(awake is called before start; When to use each?)
